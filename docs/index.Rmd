...
# Pandemie ukázala problémy s veřejnými daty
...
Frameworks pro reprodukovatelnou analýzu dat

Literate programming (Rmarkdown / Jupyter?)

Nástroje pro využití českých a světových open dat v R

Inspirace odjinud: [rOpenSci](https://ropensci.org/), [rOpenSpain](https://ropenspain.es), [rOpenGov](http://ropengov.org/), UK GDS ([RAP Companion](https://ukgovdatascience.github.io/rap_companion/))
...
Propojit/zpřístupnit ekosystém nástrojů

Zázemí v úřadech: technické, právní, HR
...
<petrbouchal.xyz/opendataexpo2021>
